        ...
        public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(
            ...
            switch (CUP$Parser$act_num) {
                ...
                case 0: // $START ::= exp EOF
                {
                    ...
                    Exp start_val = (Exp) ((java_cup.runtime.Symbol) CUP$Parser$stack
                ...
                case 1: // simple_exp ::= LPAREN exp RPAREN
                {
                    ...
                    RESULT = e;
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("simple_exp", 5,
                ...
                case 8: // exp ::= simple_exp
                {
                    ...
                    RESULT = e;
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("exp", 6,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 26: // exp ::= LET REC fundef IN exp
                {
                    ...
                    FunDef fd = (FunDef) ((java_cup.runtime.Symbol) CUP$Parser$stack
                ...
                case 29: // exp ::= LET LPAREN pat RPAREN EQUAL exp IN exp
                {
                    ...
                    Pair<List<Id>, List<Type>> p = (Pair<List<Id>, List<Type>>) ((java_cup.runtime.Symbol) CUP$Parser$stack
                ...
                case 34: // fundef ::= IDENT formal_args EQUAL exp
                {
                    ...
                    List<Id> args = (List<Id>) ((java_cup.runtime.Symbol) CUP$Parser$stack
                            .elementAt(CUP$Parser$top - 2)).value;
                    int eleft = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).left;
                    int eright = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).right;
                    Exp e = (Exp) ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
                    RESULT = new FunDef(name, TFun.gen(args.size()), args, e);
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("fundef", 4,
                ...
                case 35: // formal_args ::= IDENT formal_args
                {
                    ...
                    args.add(0, id);
                    RESULT = args;
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("formal_args", 2,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 37: // actual_args ::= actual_args simple_exp
                {
                    ...
                    List<Exp> es = (List<Exp>) ((java_cup.runtime.Symbol) CUP$Parser$stack
                            .elementAt(CUP$Parser$top - 1)).value;
                    int eleft = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).left;
                    int eright = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).right;
                    Exp e = (Exp) ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
                    es.add(e);
                    RESULT = es;
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("actual_args", 1,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 39: // elems ::= elems COMMA exp
                {
                    ...
                    es.add(e);
                    RESULT = es;
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("elems", 0,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 41: // pat ::= pat COMMA IDENT
                {
                    ...
                    Pair<List<Id>, List<Type>> is = (Pair<List<Id>, List<Type>>) ((java_cup.runtime.Symbol) CUP$Parser$stack
                            .elementAt(CUP$Parser$top - 2)).value;
                    int ileft = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).left;
                    int iright = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).right;
                    ...
                    is.left.add(i);
                    RESULT = is;
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("pat", 3,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 42: // pat ::= IDENT COMMA IDENT
                {
                    ...
                    l.add(0, i2);
                    l.add(0, i1);
                    RESULT = new Pair<List<Id>, List<Type>>(l, null);
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("pat", 3,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
